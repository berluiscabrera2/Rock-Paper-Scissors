...
rockBtn.addEventListener("click", function () {
  ...
  document.getElementById('playerText').innerHTML = "Player: ".concat(player);
  document.getElementById('computerText').innerHTML = "Computer: ".concat(computer);
  document.getElementById('resultText').innerHTML = "Result: ".concat(result);
});
